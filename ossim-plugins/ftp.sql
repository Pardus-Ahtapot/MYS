...
SET @pluginid = 91115;
SET @type = 1;
SET @pluginname = 'honeypot_ftp';
SET @desc = 'FTP Honeypot System';
SET @product_type = 11;
SET @vendor = NULL;
...
INSERT IGNORE INTO plugin_sid (plugin_id, sid, reliability,
                               ...
                               category_id, name) VALUES (@pluginid, 1, 1, 1, 11, 19, 'honeypot_ftp: FTP Connected');
INSERT IGNORE INTO plugin_sid (plugin_id, sid, reliability,
                               priority, subcategory_id,
                               category_id, name) VALUES (@pluginid, 2, 1, 1, 11, 19, 'honeypot_ftp: FTP Command Detected');
INSERT IGNORE INTO plugin_sid (plugin_id, sid, reliability,
                               priority, subcategory_id,
                               category_id, name) VALUES (@pluginid, 3, 1, 1, 11, 19, 'honeypot_ftp: FTP Disconnected');
